...
//ROTAS PARA USAR
const povCharacterRoutes = require('./controllers/povCharController');
app.use('/got', povCharacterRoutes)

const charsRoutes = require('./controllers/alllCharsController')
app.use('/allcharacters', charsRoutes)

const bookRoutes = require('./controllers/books64Controller')
